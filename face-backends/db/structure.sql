...
--
-- Name: face_collections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.face_collections (
    id bigint NOT NULL,
    namespace character varying(12) NOT NULL,
    name character varying(24) NOT NULL,
    description character varying(128),
    sample_columns jsonb DEFAULT '[]'::jsonb NOT NULL,
    face_columns jsonb DEFAULT '[]'::jsonb NOT NULL,
    store_face_info boolean DEFAULT false NOT NULL,
    storage_engine character varying DEFAULT 'ACTIVE_STORAGE'::character varying NOT NULL,
    shards_count integer DEFAULT 0 NOT NULL,
    replicas_count integer DEFAULT 0 NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: face_collections_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.face_collections_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: face_collections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.face_collections_id_seq OWNED BY public.face_collections.id;


--
-- Name: face_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.face_records (
    id bigint NOT NULL,
    face_sample_id bigint NOT NULL,
    face_key character varying(36) NOT NULL,
...
--
-- Name: face_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.face_records_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: face_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.face_records_id_seq OWNED BY public.face_records.id;


--
-- Name: face_samples; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.face_samples (
    id bigint NOT NULL,
    face_collection_id bigint NOT NULL,
    sample_key character varying(32) NOT NULL,
    metadata jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: face_samples_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.face_samples_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: face_samples_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.face_samples_id_seq OWNED BY public.face_samples.id;
...
--
-- Name: face_collections id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_collections ALTER COLUMN id SET DEFAULT nextval('public.face_collections_id_seq'::regclass);


--
-- Name: face_records id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_records ALTER COLUMN id SET DEFAULT nextval('public.face_records_id_seq'::regclass);


--
-- Name: face_samples id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_samples ALTER COLUMN id SET DEFAULT nextval('public.face_samples_id_seq'::regclass);
...
--
-- Name: face_collections face_collections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_collections
    ADD CONSTRAINT face_collections_pkey PRIMARY KEY (id);


--
-- Name: face_records face_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_records
    ADD CONSTRAINT face_records_pkey PRIMARY KEY (id);


--
-- Name: face_samples face_samples_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_samples
    ADD CONSTRAINT face_samples_pkey PRIMARY KEY (id);
...
--
-- Name: index_face_collections_on_namespace; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_face_collections_on_namespace ON public.face_collections USING btree (namespace);


--
-- Name: index_face_collections_on_namespace_and_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_face_collections_on_namespace_and_name ON public.face_collections USING btree (namespace, name);


--
-- Name: index_face_records_on_embedding; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_face_records_on_embedding ON public.face_records USING hnsw (embedding public.vector_cosine_ops);


--
-- Name: index_face_records_on_embedding_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_face_records_on_embedding_status ON public.face_records USING btree (embedding_status);


--
-- Name: index_face_records_on_face_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_face_records_on_face_key ON public.face_records USING btree (face_key);


--
-- Name: index_face_records_on_face_sample_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_face_records_on_face_sample_id ON public.face_records USING btree (face_sample_id);


--
-- Name: index_face_samples_on_face_collection_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_face_samples_on_face_collection_id ON public.face_samples USING btree (face_collection_id);


--
-- Name: index_face_samples_on_face_collection_id_and_sample_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_face_samples_on_face_collection_id_and_sample_key ON public.face_samples USING btree (face_collection_id, sample_key);
...
--
-- Name: face_samples fk_rails_7cae29869c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_samples
    ADD CONSTRAINT fk_rails_7cae29869c FOREIGN KEY (face_collection_id) REFERENCES public.face_collections(id);
...
--
-- Name: face_records fk_rails_f16f1ea5dd; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.face_records
    ADD CONSTRAINT fk_rails_f16f1ea5dd FOREIGN KEY (face_sample_id) REFERENCES public.face_samples(id);
